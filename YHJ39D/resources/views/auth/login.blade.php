            ...
            <div class="shadow-md rounded-md p-4 bg-gray-100">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" type="email" class="border border-gray-400 p-2 w-full @error('email') border-red-500 @enderror" name="email" value="{{ old('email') }}" autocomplete="email" autofocus>
                        @error('email')
                    ...
                    <div class="mb-4">
                        ...
                        <input id="password" type="password" class="border border-gray-400 p-2 w-full @error('password') border-red-500 @enderror" name="password" autocomplete="current-password">
                        @error('password')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
