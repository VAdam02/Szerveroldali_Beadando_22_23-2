            ...
            <div class="shadow-md rounded-md p-4 bg-gray-100">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="name" type="text" class="border border-gray-400 p-2 w-full @error('name') border-red-500 @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" type="email" class="border border-gray-400 p-2 w-full @error('email') border-red-500 @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                        @error('email')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input id="password" type="password" class="border border-gray-400 p-2 w-full @error('password') border-red-500 @enderror" name="password" required autocomplete="new-password">
                        @error('password')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
